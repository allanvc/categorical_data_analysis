...
Neste exemplo são utilizados os seguintes pacotes: *dplyr*, *magrittr*, *tibble*, *broom*, *reshape2*, *plotly*, *lmtest*, *ResouceSelection* e *modEvA*. Para a confecção do documento html, é necessário o pacote *rmarkdown*.
